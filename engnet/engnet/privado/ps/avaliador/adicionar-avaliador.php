...
<head>
  ...
  <title>Processo Seletivo - Adicionar Avaliador</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Selecione um membro para se tornar avaliador</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                      $adicionarAvaliadores = selecionarObjeto("membros");

                      while($avaliador = $adicionarAvaliadores->fetch_assoc()){
                ?>
                <tr>
                  <td><?php echo $avaliador["nome"]; ?></td>
                  <td><a href="add-av.php?id=<?php echo $avaliador["id"] ?>&idPs=<?php echo $_GET['id'] ?>"><span class="label label-success">Adicionar</span></a></td>
                </tr>
                <?php 
                  }
                ?>
