        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Selecione um Processo Seletivo</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="selecionar-candidato.php?id=<?php echo $ps['id']?>"><span class="label label-success">Escolher</span></a></td>
                </tr>
                <?php
                  }}
                ?>
