...
<head>
  ...
  <title>Processo Seletivo - Listar Avaliador</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listar Avaliadores</li>
      </ol>
    </section>
    <!-- Main content -->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                  $listaAvaliadores = selecionarObjeto("avaliador");
                   while($listaAvaliador = $listaAvaliadores->fetch_assoc()){
                ?>
                <tr>
                  <td><?php $avaliadorPs = selecionarObjetoPorId("membros", $listaAvaliador["usuario"]); echo $avaliadorPs["nome"]; ?></td>
                  <td><?php echo $avaliadorPs["diretoria"]; ?></td>
                  <td><a href="del-av?avaliador=<?php echo $listaAvaliador['id']?>"><span class="label label-danger">Excluir</span></a></td>
                </tr>
                <?php
                  }
                ?>
