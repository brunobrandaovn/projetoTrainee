...
<head>
  ...
  <title>Processo Seletivo - Selecionar PS</title>
...
<div class="wrapper">
  <?php //if(isset($_GET['id'])){ header("Location: avaliar.php");}?>
  <!-- Cabecalho do site-->
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="tabelaCandidatos" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                  $listarCandidatos = selecionarObjetoPs("candidatos", $_GET["id"]);
                ...
                <tr>
                  ...
                  <?php 
                          $mb = selecionarMembro();
                        if (verificarAvaliacao($mb["id"], $listarCandidato["id"])) {
                          ?>
                           <td><span class="label label-success">Avaliado</span></td>
                          <?php
                        }else{
                          ?>
                         
                          <td><a href="avaliar-candidato.php?idPs=<?php echo $_GET['id']?>&idCan=<?php echo $candidato['id'];?>"><span class="label label-info">Avaliar</span></a></td>
                          <?php
                        }
                  ?>
