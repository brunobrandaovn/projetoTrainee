        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Selecione um processo seletivo para adicionar avaliadores.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                      $processos = selecionarObjeto("ps");

                      while($processosSeletivos = $processos->fetch_assoc()){
                ?>
                <tr>
                  <td><?php echo $processosSeletivos["nome"]; ?></td>
                  <td><a href="adicionar-avaliador.php?id=<?php echo $processosSeletivos['id'] ?>"><span class="label label-success">Selecionar</span></a></td>
                </tr>
                <?php 
                  }
                ?>
