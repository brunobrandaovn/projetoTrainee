...
<?php if(!verificaAvaliador($membro['id'])){
  ...
  if (!isset($_GET['idCan'])) {
    header("Location: selecionar.ps?erro=3");
  }else{
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="alterar-candidato.php" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="cNome">Nome</label>
                  <input type="text" class="form-control" value="<?php echo $candidato["nome"] ?>" id="cNome" name="tName" placeholder="Nome">
                </div>
                <!-- Date dd/mm/yyyy -->
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="tNascimento" value="<?php echo $candidato["nascimento"] ?>" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                </div>
              </div>
                <!-- /.input group -->
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tSemestre" class="form-control" value="<?php echo $candidato["semestre"] ?>" id="cSemestre" placeholder="Semestre">
                </div>

                <div class="form-group">
                  <label for="cMatricula">Matrícula</label>
                  <input type="text" name="tMatricula" class="form-control" id="cMatricula" value="<?php echo $candidato["matricula"] ?>" placeholder="Matrícula">
                </div>

                <div class="form-group">
                  <label for="cEmail">E-mail</label>
                  <input type="email" name="tEmail" class="form-control" id="cEmail" value="<?php echo $candidato["email"] ?>" placeholder="Email">
                </div>

                <div class="form-group">
                  <label for="cTelefone">Telefone</label>
                  <input type="text" name="tTelefone" class="form-control" id="cTelefone" value="<?php echo $candidato["telefone"] ?>" placeholder="Telefone">
                </div>

                <div class="form-group">
                  <label for="cMotivo">Motivo</label>
                  <textarea name="tMotivo" class="form-control" id="cMotivo" value="<?php echo $candidato["motivo"] ?>" placeholder="Motivo"></textarea>
                </div>

                <div class="form-group">
                  <label for="cPalavra">Palavra</label>
                  <input type="text" name="tPalavra" class="form-control" id="cPalavra" value="<?php echo $candidato["palavra"] ?>" placeholder="Palavra">
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <input type="hidden" name="tCandidato" value="<?php echo $idCandidato ?>">
                <button type="submit" name="tAdicionar" class="btn btn-primary">Alterar</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="alterar-foto.php" enctype="multipart/form-data" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="cArquivo">Inserir Foto</label>
                  <input type="hidden" name="tCandidato" value="<?php echo $idCandidato ?>">
                  <input type="file" name="arquivo" class="form-control" id="cArquivo" placeholder="Selecione a Imagem">
              ...
              <div class="box-footer">
                <button type="submit" name="tAlterarFoto" class="btn btn-primary">Adicionar</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
