          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                   $listaCandidatos = selecionarObjetoPs("candidatos", $_GET["id"]);
                   while($listaCandidato = $listaCandidatos->fetch_assoc()){
                ?>
                <tr>
                  <td><?php echo $listaCandidato["nome"] ?></td>
                  <td><a href="can.php?idCan=<?php echo $listaCandidato['id'] ?>"><span class="label label-info">Ver</span></a></td>
                  <td><a href="editar-candidato.php?idCan=<?php echo $listaCandidato['id'] ?>"><span class="label label-warning">Editar</span></a></td>
                  <td><a href="del-can.php?idCan=<?php echo $listaCandidato['id'] ?>"><span class="label label-danger">Excluir</span></a></td>
                </tr>
                <?php
                  }
                ?>
