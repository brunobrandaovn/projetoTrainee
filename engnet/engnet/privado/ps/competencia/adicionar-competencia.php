...
<head>
  ...
  <title>Processo Seletivo - Adicionar Competência</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Competência</li>
        <li class="active">Adicionar Competência</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Dados da competência</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="nova-com.php" method="POST"  >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tPeso" class="form-control" id="cPeso" placeholder="Peso">
                </div>
                <div class="form-group">
                  <label for="cNotaZero">Nota 0</label>
                  <input type="text" class="form-control" id="cNotaZero" name="tNotaZero" placeholder="Descrição nota 0">
                </div>
                <div class="form-group">
                  <label for="cNotaUm">Nota 1</label>
                  <input type="text" class="form-control" id="cNotaUm" name="tNotaUm" placeholder="Descrição nota 1">
                </div>
                <div class="form-group">
                  <label for="cNotaDois">Nota 2</label>
                  <input type="text" class="form-control" id="cNotaDois" name="tNotaDois" placeholder="Descrição nota 2">
                </div>
                <div class="form-group">
                  <label for="cNotaTres">Nota 3</label>
                  <input type="text" class="form-control" id="cNotaTres" name="tNotaTres" placeholder="Descrição nota 3">
                </div>
                <div class="form-group">
                  <label for="cNotaQuatro">Nota 4</label>
                  <input type="text" class="form-control" id="cNotaQuatro" name="tNotaQuatro" placeholder="Descrição nota 4">
                </div>
                <div class="form-group">
                  <label for="cNotaCinco">Nota 5</label>
                  <input type="text" class="form-control" id="cNotaCinco" name="tNotaCinco" placeholder="Descrição nota 5">
                </div>
              </div>
              <!-- /.box-body -->
