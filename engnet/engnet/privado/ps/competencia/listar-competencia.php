...
<head>
  ...
  <title>Processo Seletivo - Listar Competências</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listar Competências</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="del-com.php?idCom=<?php echo $listaCompetencia['id']?>"><span class="label label-danger">Excluir</span></a></td>
                </tr>
                <?php
                  }
                ?>
