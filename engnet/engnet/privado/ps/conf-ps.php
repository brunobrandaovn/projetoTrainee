  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Configuração PS</li>
      </ol>
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="row">
       <div class="col-xs-12">
        <div class="box box-solid">
          <div class="box">
            <div class="box-header">
              <?php 
                $id = $_GET['id'];
                $ps = selecionarObjetoPorId("ps", $id); ?> 
              <h3 class="box-title">Você está editando o processo seletivo <?php echo $ps["nome"]; ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form action="alterar-status-ps.php" method="post" class="col-md-4">
                <div class="form-group">
                  <label>Status do Processo Seletivo</label>
                  <input type="hidden" value="<?php echo $ps['id']?>" name="tId">
                  <select name="tStatus" id="cStatus" class="form-control" style="width: 100%;">
        ...
        <?php
          if($ps['status'] == 0){
            include "configuracao/estado-um.php";
          }
          if($ps['status'] == 1){
            include "configuracao/estado-dois.php";
          }
          if($ps['status'] == 2){
            include "configuracao/estado-tres.php";
          }
        ?> 
      <div class="row">
        <!-- Left col -->
