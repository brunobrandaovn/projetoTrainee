...
<head>
  ...
  <title>Processo Seletivo - Adicionar Dinâmica</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Dinâmica</li>
        <li class="active">Adicionar Dinâmica</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Dados da dinâmica</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="nova-din.php" method="POST"  >
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="tPeso" class="form-control" id="cPeso"  value="1"  placeholder="Peso">
                </div>
                <div class="form-group">
                  <label>Descrição</label>
                  <textarea id="editor1" name="tEditor" rows="10" cols="80"></textarea>
                </div>
              </div>
...
<!-- CK Editor -->
<script src="http://localhost/engnet/engnet/bower_components/ckeditor/ckeditor.js"></script>
</body>
</html>
