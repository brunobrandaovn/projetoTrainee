...
<?php if (!isset($_GET["idDin"])){
    header("Location: ../../index.php");
}else{
    $idDinamica = $_GET["idDin"];
    $dinamica = selecionarObjetoPorId("dinamicas", $idDinamica);
?>
<!DOCTYPE html>
<html>
<head>
  ...
  <title>Processo Seletivo - <?php echo $dinamca["nome"] ?></title>
      ...
      <!-- Profile Image -->
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center"><?php echo $dinamica["nome"];?></h3>

              <p class="text-muted text-center">Dinamica</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Peso</b> <a class="pull-right"><?php echo $dinamica["peso"] ?></a>
                </li>
                <li class="list-group-item">
                  <b>Descrição</b>
                </li>
                <p><?php echo $dinamica["descricao"]; ?></p>
              </ul>
            </div>
            <!-- /.box-body -->
          </div>
