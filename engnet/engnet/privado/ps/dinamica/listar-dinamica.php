...
<head>
  ...
  <title>Processo Seletivo - Listar Dinamicas</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Listar Dinâmicas</li>
      </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="box-body">
              <table id="tabelaProcessos" class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td><a href="din.php?idDin=<?php echo $listarDinamica['id'] ?>"><span class="label label-info">Ver</span></a></td>
                  <td><a href="del-din.php?dinamica=<?php echo $listarDinamica['id'];?>"><span class="label label-danger">Excluir</span></a></td>
                </tr>
                <?php
                    } 
                ?>
